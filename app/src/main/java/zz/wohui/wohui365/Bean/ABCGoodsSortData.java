...
public class ABCGoodsSortData {
    ...
    private List<BCGoodsSortData> bcGoodsSortList;
    ...
    public List<BCGoodsSortData> getBcGoodsSortList() {
        return bcGoodsSortList;
    }

    public void setBcGoodsSortList(List<BCGoodsSortData> bcGoodsSortList) {
        this.bcGoodsSortList = bcGoodsSortList;
    }
